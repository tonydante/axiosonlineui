...
function AdminSignup(props) {
  ...
  const onSubmit = (event) => {
    ...
    if (password.trim() !== confirmPassword.trim()) {
      ...
      const fields = { username, password, email, role: "admin" };
              ...
              <div className="col-xl-5 col-md-6">
                ...
                <div className="auth-form card">
                  ...
                  <div className="card-body">
                    <form method="post" className="signup_validate">
                    ...
                    <div className="new-account mt-3">
                      <p>
                        ...
                        <Link className="text-primary" to="/admin/signin">
                          Sign in
                        </Link>
                      </p>
                    </div>
...
export default connect(null, { SignupRequest })(withRouter(AdminSignup));
